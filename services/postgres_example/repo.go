...
type (
	Setter interface {
		Set(ctx context.Context, t *Thing) error
	}
	SetterFunc func(ctx context.Context, t *Thing) error
)

func (f SetterFunc) Set(ctx context.Context, t *Thing) error {
	return f(ctx, t)
}
...
func (r *repo) Set(ctx context.Context, t *Thing) error {
